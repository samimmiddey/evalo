                  ...
                  <Button
                     ...
                     {selectedValues.length > 0 ? (
                        <div className="flex justify-between items-center w-full">
                           <div
                                    ...
                                    return (
                                       <Badge
                                          ...
                                          <div
                                             ...
                                             className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50 flex items-center">
                                             <XCircle
                                                className={cn(
                                                   "h-3 w-3",
                                                   responsiveSettings.compactMode &&
                              ...
                              {selectedValues.length > responsiveSettings.maxCount && (
                                 <Badge
                                    className={cn(
                                       "bg-zinc-500/15 text-zinc-300 border border-white/15 hover:bg-zinc-500/30",
                                       getBadgeAnimationClass(),
                                       multiSelectVariants({ variant }),
                                       responsiveSettings.compactMode &&
                                       "text-xs px-1.5 py-0.5",
                           ...
                           <div className="flex items-center justify-between">
                              ...
                              />
                              <ChevronDown
                                 className={cn("h-4 mx-2 cursor-pointer text-muted-foreground transition-transform duration-200", isPopoverOpen && "rotate-180")}
                                 aria-hidden="true"
                              />
                           </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between w-full mx-auto">
                           ...
                           <ChevronDown className={cn("h-4 cursor-pointer text-muted-foreground mx-2 transition-transform duration-200", isPopoverOpen && "rotate-180")} />
                        </div>
                     )}
                  </Button>
               </PopoverTrigger>
