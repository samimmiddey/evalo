      ...
      <div className="shrink-0 bg-zinc-900/80 border-b border-white/10 px-4 py-2.5 backdrop-blur-md">
         ...
         >
            <TabsList className="w-full bg-zinc-950/70 border border-white/10 h-10! group-data-horizontal/tabs:h-10! p-1 gap-1.5 rounded-xl">
               <TabsTrigger
                  value="video"
                  className="flex-1 h-full! py-2! gap-2 rounded-lg data-active:bg-violet-500/15 data-active:border-white/10! data-active:border text-zinc-400 hover:text-zinc-200 text-xs font-medium transition-all cursor-pointer"
               >
               ...
               <TabsTrigger
                  value="chat"
                  className="flex-1 h-full! py-2! gap-2 rounded-lg relative data-active:bg-violet-500/15 data-active:border-white/10! data-active:border text-zinc-400 hover:text-zinc-200 text-xs font-medium transition-all cursor-pointer"
               >
