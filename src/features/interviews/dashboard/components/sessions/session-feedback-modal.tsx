...
import { SessionFeedback } from "../../types/dashboard.types";
...
export const SessionFeedbackModal = ({
   ...
   return (
      <ModalWrapper
         open={open}
         onClose={onClose}
         title={`Session Feedback — ${candidateName}`}
         description="Review the AI-assisted performance breakdown, candidate review, and session assessment."
      >
         <div className="py-4 space-y-6 text-zinc-100 font-inter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               ...
               <div className="p-5 rounded-xl border border-white/5 bg-zinc-900/50 flex flex-col justify-between gap-3">
                  ...
                  <PrimaryBody
                     text="Evaluation status recorded for this mock interview."
                  ...
                  <div>
                     ...
                     <div className="flex items-center gap-1 mt-1">
                        {sessionRating ? (
                           ...
                           <span className="text-xs text-zinc-500 italic">No rating given</span>
                        )}
                     </div>
                  </div>
                  <PrimaryBody
                     text="Score provided by candidate."
                     className="text-xs! lg:text-xs! 2xl:text-xs! text-zinc-400!"
                  />
               </div>
            ...
            {/* Candidate Review Comment if any */}
            {sessionComment && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               {/* Technical Skills */}
               <div className="p-5 rounded-xl border border-white/5 bg-zinc-900/40 space-y-3">
               ...
               <div className="p-5 rounded-xl border border-white/5 bg-zinc-900/40 space-y-3">
                  <div className="flex items-center gap-2 text-xs font-bold text-violet-400 uppercase tracking-wider">
                     <MessageSquare className="w-4 h-4" /> Communication & Clarity
                  </div>
                  <PrimaryBody
                     text={communication}
                     className="text-xs! lg:text-xs! 2xl:text-xs! text-zinc-300! leading-relaxed"
