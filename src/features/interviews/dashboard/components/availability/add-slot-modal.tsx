...
const getSmartInitialDefaults = (todayStr: string) => {
   ...
   const validTodayPreset = dashboardData.slotPresets.find(
   ...
   const firstPreset = dashboardData.slotPresets[0];
         ...
         <div className="py-5 space-y-6 text-zinc-100 font-inter">
            ...
            <div className="space-y-2">
               ...
               <div className="flex flex-wrap gap-2">
                  {dashboardData.slotPresets.map((preset, idx) => {
                     ...
                     <Input
                        ...
                        onChange={(e) => {
                           ...
                           if (newDate === todayStr) {
                              ...
                              if (isCurrentExpired) {
                                 const firstValid = dashboardData.slotPresets.find(
