...
export default function OnboardingContainer({ children }: Props) {
   return (
      <div className="w-full max-w-xl 2xl:max-w-2xl mx-auto rounded-3xl border border-white/10 bg-zinc-900/85 backdrop-blur-2xl shadow-[0_25px_80px_rgba(0,0,0,0.7),0_0_50px_rgba(124,58,237,0.15)] overflow-hidden relative transition-all duration-300">
