   ...
   return (
      <div className="space-y-4 text-left">
         ...
         <div className="flex items-center justify-between">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-zinc-500/15 border border-white/10 text-zinc-300 text-xs font-medium backdrop-blur-md">
