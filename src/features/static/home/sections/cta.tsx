...
const CTA = () => {
   return (
      <div className='s-margin-t container'>
         <div className="group relative rounded-4xl overflow-hidden bg-surface-dark/80 border border-violet-500/25 transition-all duration-300 hover:-translate-y-1.25 hover:border-violet-500/50 hover:bg-surface-hover/90 hover:shadow-glow-violet px-7 py-16 lg:py-20 2xl:py-24">
            {/* Background Glow */}
